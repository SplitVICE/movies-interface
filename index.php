...
<body class="center">
    ...
    <!-- JavaScript will render content page here. -->
    <div id="main_content">
    ...
    <script>
        try {
            // This variables are created at app.js file.
            // This variables will be filled with the backend response of the movies list.
